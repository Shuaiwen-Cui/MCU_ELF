...
git add .
git status
git commit -m 'auto update mcu elf'
echo '--------commit successfully--------'

# git push -f https://github.com/Shuaiwen-Cui/MCU_ELF.git main
git push -u https://github.com/Shuaiwen-Cui/MCU_ELF.git main
# git remote add origin https://github.com/Shuaiwen-Cui/MCU_ELF.git
